...
| 분석 샘플 | 통합분석 리포트 시각화 버전 (ProductReportView 재사용, iframe 제거) | 완료 | 2026-04-15 |
| 디자인 | FlareLane 스타일 + 다크모드 자동 대응 (prefers-color-scheme) | 완료 | 2026-04-15 |
| 시드 데이터 | "토토LP 교육" 제품 기준 10키워드 통합 분석 (경쟁사 4사 + 가격 TCO) | 완료 | 2026-04-15 |
| 프로필 UX | 설정 탭 제거 → 이니셜 아바타 프로필 드롭다운 (프로필/비번/로그아웃 통합) | 완료 | 2026-04-15 |
| 통합 리포트 | 상품 중심 복합 분석 11섹션 + 시각화 10종 (퍼널/매트릭스/비교표/시나리오) | 완료 | 2026-04-15 |
