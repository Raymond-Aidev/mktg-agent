...
const PHASES = [
  { id: "P0", name: "계약·착수", weeks: "~2주", who: "공동",
    ...
    activities: ["착수보고", "범위·일정(WBS) 확정", "담당자·역할 지정", "협업 포털 오픈"],
  ...
  { id: "P3", name: "설계 (PRD·SRD)", weeks: "3~4주", who: "수행사 중심",
    ...
    activities: ["TO-BE 프로세스 설계", "시스템·연동 아키텍처", "권한·계정(IAM) 설계", "화면·데이터 설계"],
  ...
  { id: "P6", name: "전환·안정화", weeks: "3~4주", who: "공동",
    ...
    activities: ["데이터 이관", "컷오버(전환)", "Hypercare 안정화", "수정·보완", "운영 인수인계"],
